...
<head>
    ...
    <!-- Title  -->
     @include('partials.title', ['title' => 'Aptidões'])
    <!-- Title  -->
...
<body>
    ...
    <!-- ***** Header Area Start ***** -->
    @include('partials.header',['category' => 'skills'])
    <!-- ***** Header Area End ***** -->

    <!-- ********** Hero Area Start ********** -->
    <div class="hero-area height-400 bg-img background-overlay" style="background-image: url('/img/blog-img/blog_douggs_img_category_skills.png');"></div>
    <!-- ********** Hero Area End ********** -->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-8 col-lg-4">
                    <div class="post-sidebar-area">
                        ...
                        <!-- It's here -->
                        @include('partials.it_is_here', ['description' => 'Aqui são apresentadas as capacidades e aptidões relevantes ao desenvolvimento de software do proffissional Douglas G. De Souza.'])
                        <!-- It's here -->
