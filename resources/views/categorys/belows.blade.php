...
<head>
    ...
    <!-- Title  -->
     @include('partials.title', ['title' => 'Infraestruturas'])
    <!-- Title  -->
...
<body>
    ...
    <!-- ***** Header Area Start ***** -->
    @include('partials.header',['category' => 'belows'])
    <!-- ***** Header Area End ***** -->

    <!-- ********** Hero Area Start ********** -->
    <div class="hero-area height-400 bg-img background-overlay" style="background-image: url('/img/blog-img/blog_douggs_img_category_belows.png');"></div>
    <!-- ********** Hero Area End ********** -->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-8 col-lg-4">
                    <div class="post-sidebar-area">
                        ...
                        <!-- It's here -->
                        @include('partials.it_is_here', ['description' => 'Por vezes, no que diz respeito à Infraestrutura, é preciso tentar enxergar com uma clareza melhor quanto ao que deve ser utilizado para um desenvolvimento expecífico, ou para compreender a vantagem do que há de novo.'])
                        <!-- It's here -->
